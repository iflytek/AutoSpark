...
from autospark.vector_store.pinecone import Pinecone
from autospark.vector_store.weaviate import Weaviate
from autospark.vector_store.qdrant import Qdrant
...
class TestVectorFactory(unittest.TestCase):
    ...
    @patch('autospark.vector_store.vector_factory.get_config')
    @patch('autospark.vector_store.vector_factory.pinecone')
    @patch('autospark.vector_store.vector_factory.weaviate')
    @patch('autospark.vector_store.vector_factory.Qdrant')
