...
from autospark.tools.github.delete_file import GithubDeleteFileTool, GithubDeleteFileSchema


def test_github_delete_file_tool():
    # Test case: Successfully delete a file and create a pull request
    with patch("autospark.tools.github.delete_file.GithubHelper") as mock_github_helper:
