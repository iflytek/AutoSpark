...
@patch('autospark.tools.code.write_test.PromptReader')
@patch('autospark.tools.code.write_test.AgentPromptBuilder')
@patch('autospark.tools.code.write_test.TokenCounter')
