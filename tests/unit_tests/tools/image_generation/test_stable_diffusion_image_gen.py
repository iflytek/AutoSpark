...
from autospark.tools.image_generation.stable_diffusion_image_gen import StableDiffusionImageGenTool
...
def stable_diffusion_tool():
    with patch('autospark.tools.image_generation.stable_diffusion_image_gen.requests.post') as post_mock, \
            patch(
                'autospark.tools.image_generation.stable_diffusion_image_gen.FileManager') as resource_manager_mock:
