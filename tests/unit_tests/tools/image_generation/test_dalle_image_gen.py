...
from autospark.tools.image_generation.dalle_image_gen import DalleImageGenTool


@patch('autospark.tools.image_generation.dalle_image_gen.OpenAiDalle')
@patch('autospark.tools.image_generation.dalle_image_gen.requests')
