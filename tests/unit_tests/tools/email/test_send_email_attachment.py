...
import os
from autospark.tools.email.send_email_attachment import SendEmailAttachmentTool, SendEmailAttachmentInput

class TestSendEmailAttachmentTool(unittest.TestCase):
    @patch("autospark.models.agent.Agent.get_agent_from_id")
    @patch("autospark.tools.email.send_email_attachment.SendEmailAttachmentTool.send_email_with_attachment")
    @patch("autospark.helper.resource_helper.ResourceHelper.get_agent_read_resource_path")
    @patch("autospark.helper.resource_helper.ResourceHelper.get_root_input_dir")
