...
from autospark.tools.twitter.send_tweets import SendTweetsInput, SendTweetsTool
...
class TestSendTweetsTool(unittest.TestCase):
    @patch('autospark.helper.twitter_tokens.TwitterTokens.get_twitter_creds', return_value={'token': '123', 'token_secret': '456'})
    @patch('autospark.helper.twitter_helper.TwitterHelper.get_media_ids', return_value=[789])
    @patch('autospark.helper.twitter_helper.TwitterHelper.send_tweets')
