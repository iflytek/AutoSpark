import pytest
from autospark.tools.duck_duck_go.duck_duck_go_search_toolkit import DuckDuckGoToolkit
from autospark.tools.duck_duck_go.duck_duck_go_search import DuckDuckGoSearchTool
