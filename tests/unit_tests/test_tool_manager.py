...
from autospark.tool_manager import parse_github_url, download_tool, load_tools_config, download_and_extract_tools
...
@patch('autospark.tool_manager.download_tool')
@patch('autospark.tool_manager.load_tools_config')
def test_download_and_extract_tools(mock_load_tools_config, mock_download_tool):
    ...
    mock_download_tool.assert_any_call('url1', os.path.join('autospark', 'tools', 'tool1'))
    mock_download_tool.assert_any_call('url2', os.path.join('autospark', 'tools', 'tool2'))
