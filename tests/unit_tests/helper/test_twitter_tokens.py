...
from autospark.helper.twitter_tokens import Creds, TwitterTokens
...
class TestTwitterTokens(unittest.TestCase):
    ...
    @patch('autospark.helper.twitter_tokens.TwitterTokens.gen_nonce', return_value=123456)  # Replace '__main__' with actual module name
    @patch('autospark.helper.twitter_tokens.TwitterTokens.percent_encode', return_value="encoded")  # Replace '__main__' with actual module name
