...
@patch('autospark.worker.execute_agent.delay')
@patch('autospark.jobs.scheduling_executor.Session')
@patch('autospark.models.agent.Agent')
@patch('autospark.jobs.scheduling_executor.AgentWorkflow')
@patch('autospark.models.agent_execution.AgentExecution')
