...
export default function App() {
    ...
    useEffect(() => {
        ...
        loadingTextEffect('正在初始化...', setLoadingText, 500);
            ...
            {applicationState === 'AUTHENTICATED' && !showMarketplace ? (<div className="projectStyle">
                ...
                <div className="workSpaceStyle">
                    <div className="topBarStyle">
                        <TopBar selectedProject={selectedProject} organisationId={organisationId} userName={userName}
                                env={env}/>
                    </div>
                ...
                <div className="signInCenter">
                    {applicationState === 'NOT_AUTHENTICATED' && !showMarketplace ? <div className="signInWrapper">
                        ...
                        <div className="signInInfo"
                             style={{fontSize: '16px', fontFamily: 'Source Code Pro'}}>{loadingText}</div>
                    </div>}
                </div>
            </div>) : true}
        </div>
