      ...
      <div className={styles.top_left}>
        <div className={styles.top_bar_section}
          ...
          <div style={{display: 'flex', alignItems: 'center', justifyContent: 'flex-start'}}>
            ...
            <div className={styles.top_bar_font}><p>默认项目</p></div>
          </div>
        ...
        <div className={styles.top_bar_section} style={{marginLeft: '7px', cursor: 'pointer'}}>
          ...
          <div className={styles.top_bar_font} style={{marginLeft: '-1px'}}
               onClick={() => openNewTab(-4, "Marketplace", "Marketplace", false)}><p>市场</p></div>
        </div>
      </div>
      <div className={styles.top_right}>

        <div onClick={() => openNewTab(-3, "Settings", "Settings", false)} className={styles.top_right_icon}>
          <div className={styles.top_right_icon}>
            <Image
          width={16} height={16} className={styles.top_settings_icon} src="/images/settings.svg" alt="dropdown-icon"/></div>
