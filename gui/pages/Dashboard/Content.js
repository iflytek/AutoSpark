      ...
      <div style={{display: 'flex', height: '100%'}}>
        ...
        {tabs.length <= 0 ? <div className={styles.main_workspace} style={selectedView === '' ? {
            ...
            <div>
              ...
              <div style={{width: '100%', display: 'flex', justifyContent: 'center', marginTop: '30px'}}>
                <button onClick={() => addTab({
                 ...
                 创建新代理&nbsp;<Image width={17} height={17} src="/images/arrow_forward_secondary.svg"
                                               alt="forward-arrow"/>
                </button>
              </div>
              {agents && agents.length > 0 &&
                <div style={{width: '100%', display: 'flex', justifyContent: 'center', marginTop: '12px'}}>
                  <button onClick={getLastActive} className={styles.empty_state_button}>
                    查看最后一个活跃代理&nbsp;<Image width={17} height={17} src="/images/arrow_forward_secondary.svg"
                                                       alt="forward-arrow"/>
                  </button>
                </div>}
              {env !== 'PROD' &&
                <div style={{width: '100%', display: 'flex', justifyContent: 'center', marginTop: '12px'}}>
                  <button onClick={() => addTab({
                    ...
                    添加自定义工具&nbsp;<Image width={17} height={17} src="/images/arrow_forward_secondary.svg"
                                                alt="forward-arrow"/>
                  </button>
                </div>}
              <div style={{width: '100%', display: 'flex', justifyContent: 'center', marginTop: '12px'}}>
                <button onClick={() => addTab({id: -3, name: "Settings", contentType: "Settings"})}
                        className={styles.empty_state_button}>
                  前往设置&nbsp;<Image width={17} height={17} src="/images/arrow_forward_secondary.svg"
                                             alt="forward-arrow"/>
                </button>
              </div>
            </div>
          ...
          <div className={styles.tab_detail}
               style={tabs.length > 0 ? {backgroundColor: '#f9f9f9', overflowX: 'hidden'} : {}}>
