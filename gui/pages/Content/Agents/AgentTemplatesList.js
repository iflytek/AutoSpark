        ...
        <div>
          <div className='row' style={{marginTop: '10px'}}>
            <div className='col-12'>
              ...
              <button className="primary_button" onClick={redirectToCreateAgent}
                      style={{float: 'right', marginRight: '3px'}}>&nbsp;从头开始构建
              </button>
            </div>
          </div>
          <div className={styles.rowContainer}
            ...
            {agentTemplates.length > 0 ? <div className={styles.resources}>
              ...
              <div className={styles.market_tool} style={{cursor: 'pointer', height: '85px',}}
                ...
                <div style={{display: 'inline', overflow: 'auto'}}>
                  ...
                  SuperAGI市场提供了大量模板可供选择，因此您一定能找到适合您的模板！
                  </div>
                </div>
              </div>
