  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const models = ['gpt-4', 'gpt-3.5-turbo', 'gpt-3.5-turbo-16k', 'gpt-4-32k', 'google-palm-bison-001', 'spark-2.1'];
    ...
    <div className={style.apm_dashboard_container}>
      <div id="apm_dashboard" className={style.apm_dashboard}>
        <div style={{
          ...
          <span className="text_14 mt_6 ml_6">代理性能监控</span>
        ...
        <ResponsiveGridLayout
          ...
          <div key="total_agents" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">代理总数</span>
            <div
          ...
          <div key="total_tokens" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">消耗Token总数</span>
            <div
          ...
          <div key="total_runs" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">任务运行总数</span>
            <div
          ...
          <div key="models_by_agents" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">每个模型的代理数</span>
          ...
          <div key="runs_by_model" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">每个模型的运行任务数</span>
          ...
          <div key="tokens_by_model" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">模型消耗的Token总数</span>
          ...
          <div key="most_used_tools" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">最常用的工具</span>
            {toolsUsed.length === 0 ?
          ...
          <div key="agent_details" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">代理概览</span>
            {allAgents.length === 0 ?
              <div className="vertical_container align_center mt_50 w_100">
                ...
                <table className="table_css mt_10" style={{margin: 0, padding: 0}}>
                  <thead>
                  <tr style={{borderTop: 'none'}}>
                    <th className="table_header" style={{width: '14%'}}>代理名称</th>
                    <th className="table_header text_align_right" style={{width: '10%'}}>Model <img width={14}
                                                                                                    height={14}
                                                                                                    src="/images/arrow_downward.svg"
                                                                                                    alt="arrow_down"/>
                    </th>
                    <th className="table_header text_align_right" style={{width: '12%'}}>消耗Token数<img width={14}
                                                                                                              height={14}
                                                                                                              src="/images/arrow_downward.svg"
                                                                                                              alt="arrow_down"/>
                    </th>
                    <th className="table_header text_align_right" style={{width: '9%'}}>运行任务数 <img width={14} height={14}
                                                                                                  src="/images/arrow_downward.svg"
                                                                                                  alt="arrow_down"/>
                    </th>
                    <th className="table_header text_align_right" style={{width: '15%'}}>每次运行平均Token数<img
                    ...
                    <th className="table_header text_align_right" style={{width: '10%'}}>调用次数 <img width={14}
                                                                                                    height={14}
                                                                                                    src="/images/arrow_downward.svg"
                                                                                                    alt="arrow_down"/>
                    </th>
                    <th className="table_header text_align_right" style={{width: '10%'}}>平均运行时间<img width={14}
                                                                                                           height={14}
                                                                                                           src="/images/arrow_downward.svg"
                                                                                                           alt="arrow_down"/>
                    </th>
                ...
                <div className="overflow_auto w_100">
                  <table className="table_css mt_10" style={{margin: 0}}>
                    ...
                    {allAgents.map((run, i) => (
                      <tr key={i}>
                        <td className="table_data" style={{width: '14%'}}>{run.name}</td>
                        ...
                        <td className="table_data text_align_right" style={{width: '9%'}}>{run.runs_completed}</td>
                        <td className="table_data text_align_right"
                            style={{width: '15%'}}>{run.runs_completed ? (run.total_tokens / run.runs_completed).toFixed(1) : '-'}</td>
          ...
          <div key="active_runs" className={`${style.itembg} display_column_container`}>
            <span className="text_14 mb_8">激活运行任务</span>
          ...
          <div key="total_tokens_consumed" className={`${style.itembg} display_column_container`}>
            <div style={{display: 'inline-flex', justifyContent: 'space-between', width: '100%'}}>
              <span className="text_14 mb_8">运行任务消耗Token数</span>
            ...
            {selectedAgentRun.length > 0
              ...
              : <div className="vertical_container align_center mt_80 w_100">
                <img src="/images/no_permissions.svg" width={190} height={74} alt="No Data"/>
                <span className="text_12 mt_6">找不到运行任务</span>
              </div>}
          </div>

          <div key="total_calls_made" className={`${style.itembg} display_column_container`}>
            <div style={{display: 'inline-flex', justifyContent: 'space-between', width: '100%'}}>
              <span className="text_14 mb_8">运行任务调用次数</span>
          ...
          <div key="tokens_consumed_per_call" className={`${style.itembg} display_column_container`}>
            <div style={{display: 'inline-flex', justifyContent: 'space-between', width: '100%'}}>
              <span className="text_14 mb_8">每次运行所有调用消耗的平均Token</span>
              <div className="vertical_containers position_relative">
                {allAgents.length > 0 && <div>
                  <div className="text_14 mb_8 cursor_pointer"
