...
export const validateLLMApiKey = (model_source, model_api_key, model_api_secret, model_app_id) => {
    return api.post(`/validate-llm-api-key`, {model_source, model_api_key, model_api_secret, model_app_id});
}
...
export const getExecutionDetails = (executionId, agentId) => {
    return api.get(`/agent_executions_configs/details/agent_id/${agentId}/agent_execution_id/${executionId}`);
}
