...
from autospark.resource_manager.llama_vector_store_factory import LlamaVectorStoreFactory
...
class ResourceManager:
    ...
    def create_llama_document_s3(self, file_path: str):
        ...
        try:
            ...
            logger.error("autospark/resource_manager/resource_manager.py - create_llama_document_s3 threw : ", e)
        finally:
