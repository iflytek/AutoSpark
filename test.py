...
def run_autospark_cli(agent_name=None, agent_description=None, agent_goals=None):
...
run_autospark_cli(agent_name=agent_name, agent_description=agent_description, agent_goals=agent_goals)
